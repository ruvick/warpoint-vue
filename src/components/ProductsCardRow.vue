<template>
	...
	<div class="cards-product__catalog catalog-cards-row column" style="padding-top: 0px; padding-left: 50px; padding-right: 50px; padding-bottom: 20px; max-height: 1000px; overflow: auto; flex-wrap: nowrap;">

		<div class="column q-pt-md q-pb-md">
			<div class="catalog-cards-row__top row items-center q-pt-md q-pb-md">
				<q-breadcrumbs active-color="white" style="font-size: 24px;">
				...
				<div class="catalog-cards-row__tabl tabl-catalog-card">
					...
					>
						...
						<template v-slot:body-cell-protype="props">
							<q-td :props="props">
								<svg class="q-mr-sm" width="24" height="24" viewBox="0 0 24 24" style="margin-bottom: -5.5px;" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<template v-slot:body-cell-proremove="props">
							<q-td :props="props">
								<q-btn class="row items-center" flat round @click="removeRow(props.row)">
									<span class="block" style="font-size: 18px; color: #C7CCCC; text-transform: none;">Удалить</span>
									<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-left: 4px;">

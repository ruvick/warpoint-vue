		  ...
		  <q-card-section class="col" style="padding: 0;">
			  <div class="registration row" style="width: 100%;">
				...
				<div class="registration__body body-registration row col" style="width: 100%;">
					...
					<div class="body-registration__info" style="flex: 0 1 632px">

						<!-- No Products -->
						<div class="no-products column justify-center items-center" style="height: 100%;">
							<div class="row items-center justify-center text-h6 text-grey-10">Список товаров к оприходованию пуст
							...
							<div class="row items-center justify-center text-h6 text-grey-10">Начните добавлять товары
							</div>
						</div>

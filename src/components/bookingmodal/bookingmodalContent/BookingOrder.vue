<template>
	...
	<div class="content-booking__body body-content-booking q-pt-xl" style="flex: 1 1 auto; color: #fff;">

		<!-- Изменение заказа  -->

		<div class="text-title-middle text-grey-10 q-mb-lg">
			Изменение заказа
		</div>
		...
		<div class="row">
			<!-- Left -->
			 <div class="col">
				...
				<div class="oreder row">

					<!-- NavBar  -->
					<div class="oreder__navbar navbar-order" style="flex: 0 0 248px;">
					...
					<div class="oreder__body body-order">
			 ...
			 <!-- Right -->
			  <div class="col">
					<div class="row items-center justify-center" style="width: 100%; height: 100%;">
						<div class="row items-center justify-center text-h6 text-grey-10">Корзина пуста
							<i class="q-icon text-grey-10 q-ml-sm" aria-hidden="true" role="presentation" style="font-size: 24px;">
								<svg viewBox="0 0 24 24"><use xlink:href="icons/allIcons.svg#bascet"></use></svg>
							</i> 
						</div>
					</div>
			  </div>
		...
		<!-- Корзина пуста  -->
		 <div class="row items-center justify-center" style="width: 100%; height: 100%; display: none;">
			<div class="row items-center justify-center text-h6 text-grey-10">Корзина пуста
				<i class="q-icon text-grey-10 q-ml-sm" aria-hidden="true" role="presentation" style="font-size: 24px;">
					<svg viewBox="0 0 24 24"><use xlink:href="icons/allIcons.svg#bascet"></use></svg>
				</i> 
	...
	<div class="content-booking__footer footer-content-booking row q-pt-xs q-pr-md q-pb-xs q-pl-md">
		<div class="footer-content-booking__inner row justify-center items-center" style="width: 100%; gap: 80px;">
			...
			<q-btn unelevated class="my-btn text-weight-bold" style="background-color: #32353A; color:#616161;">
			  <span class="block">Сохранить</span>
		  </q-btn>
			...
			<q-btn unelevated color="blue-1" class="my-btn text-weight-bold">
				<span class="block">Создать заказ</span> 
			</q-btn>
